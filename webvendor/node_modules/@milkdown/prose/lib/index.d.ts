...
import { Attrs, MarkType, NodeType, Node, Slice, Mark, ResolvedPos, Schema } from 'prosemirror-model';
...
declare const CARET_MARKER = "\u2503";
declare const RANGE_OPEN_MARKER = "\u2770";
declare const RANGE_CLOSE_MARKER = "\u2771";
interface TextIndexOptions {
    blockSeparator?: string;
    leafText?: string;
}
declare function posToTextOffset(doc: Node, pos: number, options?: TextIndexOptions): number;
declare function textOffsetToPos(doc: Node, offset: number, options?: TextIndexOptions): number;
declare function getSelectionSnapshot(state: EditorState, options?: TextIndexOptions): string;
...
export type { BeforeDispatch, Captured, ContentNodeWithPos, FindNodeInSelectionResult, MarkRange, NodeWithFromTo, NodeWithPos, Options, TextIndexOptions };
